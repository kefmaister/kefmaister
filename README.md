<h2>
  Hi, I'm Kevin Dworschak!
  <img src="https://media4.giphy.com/media/v1.Y2lkPTc5MGI3NjExemI4OGpkOWVobXIzYjBwN3d3ZjVkZXFqeWg3dm55a3hrMTh1cGljOCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/u2pmTWUi0MXjyrMaVj/giphy.gif" width="50">
</h2>
...
const kevin = {
  pronouns: ["he", "him"],
  role: "Junior SAP Technical Consultant",
  tech: {
    sap: ["ABAP (basics)", "SAP UI5", "OData", "SAP BTP"],
    frontend: ["JavaScript", "TypeScript", "HTML", "CSS", "React"],
    backend: ["Node.js", "PHP", ".NET", "APIs", "GraphQL"],
    database: ["SQL", "SQLite"],
    tooling: ["Git", "CI/CD", "Automations", "Cloud basics"]
  },
  designTools: [
    "Figma",
    "Illustrator",
